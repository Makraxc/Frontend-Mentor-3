...
planetImagePlaceholder.classList.add("fade-transition");
planetName.classList.add("fade-transition");
planetDescription.classList.add("fade-transition");
distanceValue.classList.add("fade-transition");
travelTime.classList.add("fade-transition");

// Function to update content with fade transition
function updateContentWithTransition(index) {
  const destination = data.destinations[index];

  // Fade out
  planetImagePlaceholder.style.opacity = "0";
  ...
  setTimeout(() => {
    planetImagePlaceholder.src = destination.images.png;
    ...
    // Fade in
    planetImagePlaceholder.style.opacity = "1";
...
/* Event Listeners for Planet Nav */
/* Moon */
document.querySelector(".moon").addEventListener("click", (event) => {
  updateContentWithTransition(0);
});
/* Mars */
document.querySelector(".mars").addEventListener("click", (event) => {
  updateContentWithTransition(1);
});
/* Europa */
document.querySelector(".europa").addEventListener("click", (event) => {
  updateContentWithTransition(2);
});
/* Titan */
document.querySelector(".titan").addEventListener("click", (event) => {
  updateContentWithTransition(3);
});
console.log(data.destinations[3].images.png);
